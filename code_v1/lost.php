...
<head>
  ...
  <title>Daftar Kehilangan | TEMUKAN</title>
      ...
      <div class="col-md-9">
        ...
        <div class="container-fluid nav-tab">
          <div class="col-md-6 item-tab">
            <a href="lost.php" class="row active">Daftar Kehilangan</a>
          </div>
          <div class="col-md-6 item-tab">
            <a href="found.php" class="row">Daftar Penemuan</a>
          </div>
        </div>
            ...
            <div class="col-md-6 text-right">
              <form id="login-form" class="temukan-form">
                ...
                <select class="form-control" id="sort">
                  ...
                  <option>Tanggal kehilangan terbaru</option>
                  <option>Tanggal kehilangan terlama</option>
                </select>
              </form>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
              <div class="container-fluid item">
                ...
                <div class="title">
                  <a href="#" title="Telah hilang sebuah kunci sepeda motor honda vario di sekitaran keputih">Telah hilang sebuah kunci sepeda motor honda vario di sekitaran keputih</a>
                </div>
                <div class="detail">
                  <hr class="margin-0p5">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content modal-green">
        ...
        <div class="modal-body">
          ...
          <hr>
          <h4><b>Hubungi</b></h4>
          <i class="dark-grey-text">Bila anda merasa menemukan barang tersebut, silakan untuk menghubungi kontak berikut</i><br><br>
