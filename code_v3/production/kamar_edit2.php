      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
           <div class="x_panel">
            ...
            <!--         <ul class="nav navbar-right panel_toolbox">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" action="kamar_list2.php" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <a href="kamar_list2.php" class="btn btn-primary">Batal</a>
